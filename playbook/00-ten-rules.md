...
present; the expensive rig is reserved for what only the rig can prove. We ended at 314 tests
across 42 files running on a Mac with Dota not even installed, covering bot decisions, arena
